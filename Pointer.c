 ...
 * the location in the memory to where it's' stored is referred to as
 ...
 * variable. we can have pointers to characters, integers, douobles, etc.
 * we can even have pointers to functions. pointers get 
 * stored in the heap
 */
